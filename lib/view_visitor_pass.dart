...
class ViewVisitorPassPage extends StatelessWidget {
      ...
      build: (pw.Context context) {
        return pw.Column(
          ...
          children: [
            ...
            _buildPassDetailPdf('Date', '${_formatDate(dateTime)}', context),
            _buildPassDetailPdf(
                'Time', '${data['startTime']} - ${data['endTime']}', context),
            pw.SizedBox(height: 10.0),
            pw.Divider(
              height: 20,
              thickness: 2,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildSectionTitle('Visitor Detail', context),
                ...
                SizedBox(height: 10.0),
                _buildSectionTitle('Appointment Detail', context),
                _buildPassDetail('Date', '${_formatDate(dateTime)}'),
                _buildPassDetail(
...
pw.Widget _buildPassDetailPdf(String label, String value, pw.Context context) {
  return pw.Padding(
